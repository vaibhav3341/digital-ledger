    ...
    <View style={styles.container}>
      <View style={styles.balanceCard}>
        ...
        <Button
          ...
          onPress={() => navigation.navigate('AddEditTransaction', { coworkerId })}
        />
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <LedgerItem
            item={item}
            onPress={() =>
              navigation.navigate('AddEditTransaction', { coworkerId, txnId: item.txnId })
            }
          />
        )}
        ListEmptyComponent={
